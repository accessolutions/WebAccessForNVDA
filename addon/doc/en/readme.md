...
Tab to the "Modify criteria" button, or press `alt+r`.
...
In the opening menu, select the action you want to associate to this keyboard
shorcut.
...
* "Say all" : Move the browse mode cursor to the element and start reading aloud
all the text from this position.
