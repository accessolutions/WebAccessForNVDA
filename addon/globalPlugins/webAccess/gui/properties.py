...
class ListControl(ContextualSettingsPanel):
    ...
    def makeSettings(self, settingsSizer):
        ...
        self.sizer.Add(self.noPropertiesLabel, pos=(row, 0), span=(1, 3), flag=wx.EXPAND)
        ...
        self.sizer.Add(self.propertiesLabel, pos=(row, 0), flag=wx.EXPAND)
    ...
    def __init__(self, context, properties):
        ...
        for props in self.properties:
            if props.get_flag():
                ...
                itemCheck = self.Append(wx.ID_ANY, self.displayLabel(props))
